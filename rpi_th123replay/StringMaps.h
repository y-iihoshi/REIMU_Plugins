...
namespace Th123
{
	...
	extern const std::map<Th123::Mode, std::string> Modes;
	extern const std::map<Th123::Chara, std::string> Characters;
	extern const std::map<std::uint16_t, std::string> SystemCards;
	extern const std::map<Th123::Chara, std::map<std::uint16_t, std::string>> Cards;
